...
import 'package:trywidgests/app/sign_in/email_sign_in_page.dart';
import 'package:trywidgests/app/sign_in/sign_in_manager.dart';
    ...
    return ChangeNotifierProvider<ValueNotifier<bool>>(
      ...
      child: Consumer<ValueNotifier<bool>>(
        builder: (_,isLoading,__) =>  Provider<SignInManager>(
          ...
          child: Consumer<SignInManager>(builder:(_,manager,__)=>SignInPage(manager:manager, isLoading: isLoading.value,)),
        ),
      ),
    );
  }
void _showSignInError(BuildContext context,Exception exception){
  ...
  showExceptionAlertDialog(context,exception: exception, title: 'Sign in Failed',);
}
